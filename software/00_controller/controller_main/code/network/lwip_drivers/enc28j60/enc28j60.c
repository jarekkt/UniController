...
//https://github.com/xaionaro/stm32-enc28j60/blob/master/src/enc28j60.c
...
unsigned char enc28j60SendByte(uint8_t tx)
{
	uint8_t rx = 0;
	int r;

	r = HAL_SPI_TransmitReceive(getHspi(), &tx, &rx, 1, 0xffffffff);
