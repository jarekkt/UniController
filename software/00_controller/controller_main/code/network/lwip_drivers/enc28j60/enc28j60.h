...
#define ENC_CS_PIN    ETH_CS_Pin
#define ENC_CS_PORT   ETH_CS_GPIO_Port

#define ENC_INT_PIN   ETH_INT_Pin
#define ENC_INT_PORT  ETH_INT_GPIO_Port


#define ENC_RST_PIN   ETH_RST_Pin
#define ENC_RST_PORT  ETH_RST_GPIO_Port

#define unresetChip()   HAL_GPIO_WritePin(ENC_RST_PORT, ENC_RST_PIN, GPIO_PIN_SET)
#define disableChip()   HAL_GPIO_WritePin(ENC_CS_PORT, ENC_CS_PIN, GPIO_PIN_SET)
#define enableChip()    HAL_GPIO_WritePin(ENC_CS_PORT, ENC_CS_PIN, GPIO_PIN_RESET)
#define getHspi() 		 &hspi2
