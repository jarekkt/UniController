...
const var_ptable_t   params_var_ptable[] SERMON_ATTR =
{
  ...
  { "d_pulses_step_m",		   	&pctx_nv.axis[AXIS_E].pulses_step_m     	,E_VA_UINT_FREE  },
  { "d_endpos_min_mask",   		&pctx_nv.axis[AXIS_E].endpos_min_mask       ,E_VA_UINT_FREE  },
  { "d_endpos_max_mask",   		&pctx_nv.axis[AXIS_E].endpos_max_mask       ,E_VA_UINT_FREE  },
  { "d_endpos_min_value",   	&pctx_nv.axis[AXIS_E].endpos_min_value      ,E_VA_FLT_FREE   },
  { "d_endpos_max_value",   	&pctx_nv.axis[AXIS_E].endpos_max_value      ,E_VA_FLT_FREE   },
  { "d_speed_mm_s",  			&pctx_nv.axis[AXIS_E].speed_mm_s       		,E_VA_FLT_FREE   },
  { "d_speed_home_mm_s", 		&pctx_nv.axis[AXIS_E].speed_home_mm_s  		,E_VA_FLT_FREE   },
  { "d_speed_safe_mm_s",   		&pctx_nv.axis[AXIS_E].speed_safe_mm_s    	,E_VA_FLT_FREE   },
  { "d_accel_mm_s2",   			&pctx_nv.axis[AXIS_E].accel_mm_s2       	,E_VA_FLT_FREE   },
  { "d_jerk_mm_s3",   			&pctx_nv.axis[AXIS_E].jerk_mm_s3       		,E_VA_FLT_FREE   },
