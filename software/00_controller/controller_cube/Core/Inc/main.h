...
#define IN_CPU3_Pin GPIO_PIN_6
#define IN_CPU3_GPIO_Port GPIOE
#define IN_CPU6_Pin GPIO_PIN_13
#define IN_CPU6_GPIO_Port GPIOC
...
#define OUT_CPU1_PWM_Pin GPIO_PIN_9
#define OUT_CPU1_PWM_GPIO_Port GPIOE
...
#define IO_CPU8_Pin GPIO_PIN_4
#define IO_CPU8_GPIO_Port GPIOD
...
#define IO_CPU5_Pin GPIO_PIN_8
#define IO_CPU5_GPIO_Port GPIOB
